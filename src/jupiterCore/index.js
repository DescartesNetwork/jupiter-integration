...
var wrapJupiterCore = require('./wrapJupiterCore')
...
const WRAPPED_SOL_MINT = /*#__PURE__*/ new web3_js.PublicKey(
  'So11111111111111111111111111111111111111112',
)
const MAINNET_SERUM_DEX_PROGRAM = /*#__PURE__*/ new web3_js.PublicKey(
  '9xQeWvG816bUx9EPjHmaT23yvVM2ZWbrrpZb9PusVFin',
)
const DEVNET_SERUM_DEX_PROGRAM = /*#__PURE__*/ new web3_js.PublicKey(
...
const RAYDIUM_AMM_V4_PROGRAM_ID = /*#__PURE__*/ new web3_js.PublicKey(
  '675kPX9MHTjS2zt1qfr1NYHuzeLXfQM9H24wFSUt1Mp8',
)
const ALDRIN_SWAP_PROGRAM_ID = /*#__PURE__*/ new web3_js.PublicKey(
  'AMM55ShdkoGRB5jVYPjWziwk8m5MpwyDgsMWHaMSQWH6',
) // https://github.com/aldrin-exchange/aldrin-sdk/blob/f93fe3f2d847d79d8ddff507d8d4f62fd803421b/src/v2.json

const ALDRIN_SWAP_V2_PROGRAM_ID = /*#__PURE__*/ new web3_js.PublicKey(
  'CURVGoZn8zycx6FXwwevgBTB2gVvdbGTEpvMJDbgs2t4',
)
const SABER_ADD_DECIMALS_PROGRAM_ID = /*#__PURE__*/ new web3_js.PublicKey(
  'DecZY86MU5Gj7kppfUCEmd4LbXXuyZH1yHaP2NTqdiZB',
)
const CROPPER_PROGRAM_ID = /*#__PURE__*/ new web3_js.PublicKey(
  'CTMAxxk34HjKWxQ3QLZK1HpaLXmBveao3ESePXbiyfzh',
)
const SENCHA_PROGRAM_ID = /*#__PURE__*/ new web3_js.PublicKey(
  'SCHAtsf8mbjyjiv4LkhLKutTf6JnZAbdJKFkXQNMFHZ',
)
const LIFINITY_PROGRAM_ID = /*#__PURE__*/ new web3_js.PublicKey(
  'EewxydAPCCVuNEyrVN68PuSYdQ7wKn27V9Gjeoi8dy3S',
)
const CREMA_PROGRAM_ID = /*#__PURE__*/ new web3_js.PublicKey(
  '6MLxLqiXaaSUpkgMnWDTuejNZEz3kE7k2woyHGVFw319',
)
const JUPITER_WALLET = /*#__PURE__*/ new web3_js.PublicKey(
  'BUX7s2ef2htTGb2KKoPHWkmzxPj4nTWMWRgs5CSbQxf9',
)
const MERCURIAL_SWAP_PROGRAM_ID = /*#__PURE__*/ new web3_js.PublicKey(
  'MERLuDFBMmsHnsBPZw2sDQZHvXFMwp8EdjudcU2HKky',
)
const WHIRLPOOL_PROGRAM_ID = /*#__PURE__*/ new web3_js.PublicKey(
  'whirLbMiicVdio4qvUfM5KAg6Ct8VwpYzGff3uctyCc',
)
const CYKURA_PROGRAM_ID = /*#__PURE__*/ new web3_js.PublicKey(
  'cysPXAjehMpVKUapzbMCCnpFxUFFryEWEaLgnb9NrR8',
)
const CYKURA_FACTORY_STATE_ADDRESS = /*#__PURE__*/ new web3_js.PublicKey(
  'DBsMwKfeoUHhxMi9x6wd2AsT12UwUCssjNbUzu1aKgqj',
)
const MARINADE_PROGRAM_ID = /*#__PURE__*/ new web3_js.PublicKey(
  'MarBmsSgKXdrN1egZf5sqe1TMai9K1rChYNDJgjq7aD',
)
const STEPN_PROGRAM_ID = /*#__PURE__*/ new web3_js.PublicKey(
...
const CropperTokenSwapLayout = /*#__PURE__*/ bufferLayout.struct([
  /*#__PURE__*/ bufferLayout.u8('version'),
  /*#__PURE__*/ bufferLayout.u8('isInitialized'),
  /*#__PURE__*/ bufferLayout.u8('nonce'),
  /*#__PURE__*/ publicKey('ammId'),
  /*#__PURE__*/ publicKey('serumProgramId'),
  /*#__PURE__*/ publicKey('serumMarket'),
  /*#__PURE__*/ publicKey('tokenProgramId'),
  /*#__PURE__*/ publicKey('tokenAAccount'),
  /*#__PURE__*/ publicKey('tokenBAccount'),
  /*#__PURE__*/ publicKey('poolMint'),
  /*#__PURE__*/ publicKey('mintA'),
  /*#__PURE__*/ publicKey('mintB'),
])
const CropperStateLayout = /*#__PURE__*/ bufferLayout.struct([
  /*#__PURE__*/ bufferLayout.u8('isInitialized'),
  /*#__PURE__*/ publicKey('stateOwner'),
  /*#__PURE__*/ publicKey('feeOwner'),
  /*#__PURE__*/ uint64('initialSupply'),
  /*#__PURE__*/ uint64('returnFeeNumerator'),
  /*#__PURE__*/ uint64('fixedFeeNumerator'),
  /*#__PURE__*/ uint64('feeDenominator'),
  /*#__PURE__*/ bufferLayout.u8('curveType'),
  /*#__PURE__*/ bufferLayout.blob(32, 'curveParameters'),
]) // This seems to be hardcoded.

const CROPPER_STATE_ADDRESS = /*#__PURE__*/ new web3_js.PublicKey(
...
const accountInfoToCropperPoolState = (address, accountInfo) => {
  ...
  const [authority] = pubkey.findProgramAddressSync(
    [address.toBuffer()],
    programId,
  )
  return {
...
const JUPITER_PROGRAM_ID_PRODUCTION = /*#__PURE__*/ new web3_js.PublicKey(
  'JUP3c2Uh3WA4Ng34tw6kPd2G4C5BB21Xo36Je1s32Ph',
)
const JUPITER_PROGRAM_ID = JUPITER_PROGRAM_ID_PRODUCTION // JUPITER_PROGRAM_ID_PRODUCTION;

const JUPITER_PROGRAM = /*#__PURE__*/ new anchor.Program(
  IDL,
  JUPITER_PROGRAM_ID,
  {},
)
const PRODUCTION_TOKEN_LEDGERS = [
  /*#__PURE__*/ new web3_js.PublicKey(
    '755CiAfB63jK8DTZSM38ZRBTjf1inGM4QfLJTfpPM9x3',
  ),
  /*#__PURE__*/ new web3_js.PublicKey(
    '5ZZ7w2C1c348nQm4zaYgrgb8gfyyqQNzH61zPwGvEQK9',
  ),
  /*#__PURE__*/ new web3_js.PublicKey(
    'H4K65yLyYqVsDxgNCVGqK7MqrpKFLZjmqf95ZvmfyVDx',
  ),
  /*#__PURE__*/ new web3_js.PublicKey(
    'HE4STzYv5dzw2G374ynt4EYvzuKLG41P2xnNffzpdWnG',
  ),
  /*#__PURE__*/ new web3_js.PublicKey(
  ...
  /*#__PURE__*/ new web3_js.PublicKey(
    '6Q6vMHsUFA7kuwdkG9vm7gByMfk151Z9eMSwE14fHcrG',
  ),
]
const TOKEN_LEDGER =
  PRODUCTION_TOKEN_LEDGERS[
    /*#__PURE__*/ Math.floor(
      /*#__PURE__*/ Math.random() * PRODUCTION_TOKEN_LEDGERS.length,
    )
  ]
...
function raydiumAmmToRaydiumSwap(
  ...
  const [ammAuthority] = pubkey.findProgramAddressSync(
    [
      new Uint8Array(
...
function marketIntoSerumSwap(
  ...
  const vaultSigner = pubkey.createProgramAddressSync(
    [
...
function createRiskCheckAndFeeInstruction(
  userDestinationTokenAccount,
  userTransferAuthority,
  minimumOutAmount,
  tokenLedger,
  ...
  return JUPITER_PROGRAM.instruction.riskCheckAndFee(
    minimumOutAmount,
    (_platformFee$feeBps10 =
      platformFee === null || platformFee === void 0
        ? void 0
        : platformFee.feeBps) !== null && _platformFee$feeBps10 !== void 0
      ? _platformFee$feeBps10
      : 0,
    {
      accounts: {
...
function createOpenOrdersInstruction(market, userTransferAuthority) {
  const [openOrders] = pubkey.findProgramAddressSync(
    [
...
function createMarinadeFinanceDepositInstruction({
  ...
  const tempWsolTokenAccount = pubkey.findProgramAddressSync(
    [Buffer.from('temp-wsol-token-account'), transferFrom.toBuffer()],
    JUPITER_PROGRAM_ID,
  )[0]
  const tempSolPda = pubkey.findProgramAddressSync(
...
function getSaberWrappedDecimalsAmms() {
  return addDecimalsJson.map((addDecimalJson) => {
    const addDecimals = {
      ...
      wrapperUnderlyingTokens: new web3_js.PublicKey(
...
const AMM_INFO_LAYOUT_V4 = /*#__PURE__*/ bufferLayout.struct([
  /*#__PURE__*/ bufferLayout.nu64('status'),
  /*#__PURE__*/ bufferLayout.nu64('nonce'),
  /*#__PURE__*/ bufferLayout.nu64('orderNum'),
  /*#__PURE__*/ bufferLayout.nu64('depth'),
  /*#__PURE__*/ bufferLayout.nu64('coinDecimals'),
  /*#__PURE__*/ bufferLayout.nu64('pcDecimals'),
  /*#__PURE__*/ bufferLayout.nu64('state'),
  /*#__PURE__*/ bufferLayout.nu64('resetFlag'),
  /*#__PURE__*/ bufferLayout.nu64('minSize'),
  /*#__PURE__*/ bufferLayout.nu64('volMaxCutRatio'),
  /*#__PURE__*/ bufferLayout.nu64('amountWaveRatio'),
  /*#__PURE__*/ bufferLayout.nu64('coinLotSize'),
  /*#__PURE__*/ bufferLayout.nu64('pcLotSize'),
  /*#__PURE__*/ bufferLayout.nu64('minPriceMultiplier'),
  /*#__PURE__*/ bufferLayout.nu64('maxPriceMultiplier'),
  /*#__PURE__*/ bufferLayout.nu64('systemDecimalsValue'),
  /*#__PURE__*/
  // Fees
  bufferLayout.nu64('minSeparateNumerator'),
  /*#__PURE__*/ bufferLayout.nu64('minSeparateDenominator'),
  /*#__PURE__*/ bufferLayout.nu64('tradeFeeNumerator'),
  /*#__PURE__*/ bufferLayout.nu64('tradeFeeDenominator'),
  /*#__PURE__*/ bufferLayout.nu64('pnlNumerator'),
  /*#__PURE__*/ bufferLayout.nu64('pnlDenominator'),
  /*#__PURE__*/ bufferLayout.nu64('swapFeeNumerator'),
  /*#__PURE__*/ bufferLayout.nu64('swapFeeDenominator'),
  /*#__PURE__*/
  // OutPutData
  bufferLayout.nu64('needTakePnlCoin'),
  /*#__PURE__*/ bufferLayout.nu64('needTakePnlPc'),
  /*#__PURE__*/ bufferLayout.nu64('totalPnlPc'),
  /*#__PURE__*/ bufferLayout.nu64('totalPnlCoin'),
  /*#__PURE__*/ uint128('poolTotalDepositPc'),
  /*#__PURE__*/ uint128('poolTotalDepositCoin'),
  /*#__PURE__*/ uint128('swapCoinInAmount'),
  /*#__PURE__*/ uint128('swapPcOutAmount'),
  /*#__PURE__*/ bufferLayout.nu64('swapCoin2PcFee'),
  /*#__PURE__*/ uint128('swapPcInAmount'),
  /*#__PURE__*/ uint128('swapCoinOutAmount'),
  /*#__PURE__*/ bufferLayout.nu64('swapPc2CoinFee'),
  /*#__PURE__*/ publicKey('poolCoinTokenAccount'),
  /*#__PURE__*/ publicKey('poolPcTokenAccount'),
  /*#__PURE__*/ publicKey('coinMintAddress'),
  /*#__PURE__*/ publicKey('pcMintAddress'),
  /*#__PURE__*/ publicKey('lpMintAddress'),
  /*#__PURE__*/ publicKey('ammOpenOrders'),
  /*#__PURE__*/ publicKey('serumMarket'),
  /*#__PURE__*/ publicKey('serumProgramId'),
  /*#__PURE__*/ publicKey('ammTargetOrders'),
  /*#__PURE__*/ publicKey('poolWithdrawQueue'),
  /*#__PURE__*/ publicKey('poolTempLpTokenAccount'),
  /*#__PURE__*/ publicKey('ammOwner'),
  /*#__PURE__*/ publicKey('pnlOwner'),
])
...
class RaydiumAmm {
  constructor(ammId, ammAccountInfo, params) {
    ...
    this.poolCoinTokenAccount = new web3_js.PublicKey(
  ...
  static decodeSerumMarketKeysString(
    ...
    const serumVaultSigner = pubkey.createProgramAddressSync(
      [
...
function forecastSell(market, orderbook, coinIn, takerFeePct) {
  ...
  return {
    ...
    feeAmount: JSBI__default['default'].BigInt(
      new Decimal__default['default'](pcOut.toString())
        .mul(takerFeePct)
        .round(),
    ),
    priceImpactPct,
...
class SplitTradeAmm {
  constructor(firstAmm, secondAmm, reserveTokenMints) {
    ...
    this.market =
      firstAmm instanceof SerumAmm
        ? firstAmm.market
        : secondAmm instanceof SerumAmm
        ? secondAmm.market
        : null
  }
  ...
  getQuote(quoteParams) {
    ...
    for (let p = 100; (p -= 5); p > 0) {
      const firstAmount = JSBI__default['default'].divide(
        JSBI__default['default'].multiply(
          amount,
          JSBI__default['default'].BigInt(p),
        ),
        HUNDRED,
      )
      const secondAmount = JSBI__default['default'].subtract(
        amount,
        firstAmount,
      )
      ...
      const outAmount = JSBI__default['default'].add(
        firstQuote.outAmount,
        secondQuote.outAmount,
      )

      if (
        JSBI__default['default'].lessThan(outAmount, bestSolution.outAmount)
      ) {
        break
      }
    ...
    if (!bestSolution.firstQuote || !bestSolution.secondQuote) {
      throw new Error(
        'Unreachable: There was no better solution than getting 0 outAmount',
      )
    }
          ...
          amount: JSBI__default['default'].divide(
            JSBI__default['default'].divide(
              JSBI__default['default'].multiply(
                ...
                JSBI__default['default'].multiply(
                  amount,
                  JSBI__default['default'].BigInt(portion1),
                ),
              ),
              HUNDRED,
            ),
      ...
      if (secondAmmFee.mint !== sourceMintString) {
        secondAmmFee = {
          amount: JSBI__default['default'].divide(
            JSBI__default['default'].divide(
              JSBI__default['default'].multiply(
                JSBI__default['default'].multiply(secondAmmFee.amount, amount),
                JSBI__default['default'].BigInt(portion2),
              ),
              HUNDRED,
            ),
            bestSolution.outAmount,
    ...
    const feePct =
      (portion1 * firstQuote.feePct + portion2 * secondQuote.feePct) / 100
    const priceImpactPct =
      (portion1 * firstQuote.priceImpactPct +
        portion2 * secondQuote.priceImpactPct) /
      100
    return {
      notEnoughLiquidity: false,
      inAmount: quoteParams.amount,
      outAmount: outAmount,
      feeAmount: JSBI__default['default'].add(
        firstAmmFee.amount,
        secondAmmFee.amount,
      ),
  ...
  createSwapInstructions(swapParams) {
    ...
    const firstAmount = inAmount
      .mul(new BN.BN(this.portion1))
      .div(new BN.BN(HUNDRED.toString()))
    ...
    return [
      ...
      createRiskCheckAndFeeInstruction(
        ...
        new BN.BN(swapParams.otherAmountThreshold.toString()),
...
const FEES_LAYOUT = /*#__PURE__*/ bufferLayout.struct(
  [
    /*#__PURE__*/ uint64('tradeFeeNumerator'),
    /*#__PURE__*/ uint64('tradeFeeDenominator'),
    /*#__PURE__*/ uint64('ownerTradeFeeNumerator'),
    /*#__PURE__*/ uint64('ownerTradeFeeDenominator'),
    /*#__PURE__*/ uint64('ownerWithdrawFeeNumerator'),
    /*#__PURE__*/ uint64('ownerWithdrawFeeDenominator'),
  ],
  'fees',
)
const POOL_FIELDS_COMMON = [
  /*#__PURE__*/ bufferLayout.blob(8, 'padding'),
  /*#__PURE__*/ publicKey('lpTokenFreezeVault'),
  /*#__PURE__*/ publicKey('poolMint'),
  /*#__PURE__*/ publicKey('baseTokenVault'),
  /*#__PURE__*/ publicKey('baseTokenMint'),
  /*#__PURE__*/ publicKey('quoteTokenVault'),
  /*#__PURE__*/ publicKey('quoteTokenMint'),
  /*#__PURE__*/ publicKey('poolSigner'),
  /*#__PURE__*/ bufferLayout.u8('poolSignerNonce'),
  /*#__PURE__*/ publicKey('authority'),
  /*#__PURE__*/ publicKey('initializerAccount'),
  /*#__PURE__*/ publicKey('feeBaseAccount'),
  /*#__PURE__*/ publicKey('feeQuoteAccount'),
  /*#__PURE__*/ publicKey('feePoolTokenAccount'),
  FEES_LAYOUT,
]
const POOL_LAYOUT = /*#__PURE__*/ bufferLayout.struct(POOL_FIELDS_COMMON)
const POOL_V2_LAYOUT = /*#__PURE__*/ bufferLayout.struct([
  ...POOL_FIELDS_COMMON,
  /*#__PURE__*/ bufferLayout.u8('curveType'),
  /*#__PURE__*/ publicKey('curve'),
])
const STABLE_CURVE_LAYOUT = /*#__PURE__*/ bufferLayout.struct([
  /*#__PURE__*/ bufferLayout.blob(8, 'padding'),
  /*#__PURE__*/ uint64('amp'),
])
...
const STEP_TOKEN_SWAP_PROGRAM_ID = /*#__PURE__*/ new web3_js.PublicKey(
  'SSwpMgqNDsyV7mAgN9ady4bDVu5ySjmmXejXvy2vLt1',
)
const PROGRAM_ID_TO_LABEL = /*#__PURE__*/ new Map([
  ['9W959DqEETiGZocYWCQPaJ6sBmUzgfxXfqGeTEdp3aQP', 'Orca'],
  [/*#__PURE__*/ STEP_TOKEN_SWAP_PROGRAM_ID.toBase58(), 'Step'],
...
const TokenSwapLayout = /*#__PURE__*/ bufferLayout.struct([
  /*#__PURE__*/ bufferLayout.u8('version'),
  /*#__PURE__*/ bufferLayout.u8('isInitialized'),
  /*#__PURE__*/ bufferLayout.u8('bumpSeed'),
  /*#__PURE__*/ publicKey('tokenProgramId'),
  /*#__PURE__*/ publicKey('tokenAccountA'),
  /*#__PURE__*/ publicKey('tokenAccountB'),
  /*#__PURE__*/ publicKey('tokenPool'),
  /*#__PURE__*/ publicKey('mintA'),
  /*#__PURE__*/ publicKey('mintB'),
  /*#__PURE__*/ publicKey('feeAccount'),
  /*#__PURE__*/ uint64('tradeFeeNumerator'),
  /*#__PURE__*/ uint64('tradeFeeDenominator'),
  /*#__PURE__*/ uint64('ownerTradeFeeNumerator'),
  /*#__PURE__*/ uint64('ownerTradeFeeDenominator'),
  /*#__PURE__*/ uint64('ownerWithdrawFeeNumerator'),
  /*#__PURE__*/ uint64('ownerWithdrawFeeDenominator'),
  /*#__PURE__*/ uint64('hostFeeNumerator'),
  /*#__PURE__*/ uint64('hostFeeDenominator'),
  /*#__PURE__*/ bufferLayout.u8('curveType'),
  /*#__PURE__*/ bufferLayout.blob(32, 'curveParameters'),
])
const StepTokenSwapLayout = /*#__PURE__*/ bufferLayout.struct([
  ...
  /*#__PURE__*/ bufferLayout.u8('curveType'),
  /*#__PURE__*/ bufferLayout.blob(32, 'curveParameters'),
  /*#__PURE__*/ bufferLayout.u8('poolNonce'),
])
...
const MercurialSwapLayout = /*#__PURE__*/ bufferLayout.struct([
  /*#__PURE__*/ bufferLayout.u8('version'),
  /*#__PURE__*/ bufferLayout.u8('isInitialized'),
  /*#__PURE__*/ bufferLayout.u8('nonce'),
  /*#__PURE__*/ uint64('amplificationCoefficient'),
  /*#__PURE__*/ uint64('feeNumerator'),
  /*#__PURE__*/ uint64('adminFeeNumerator'),
  /*#__PURE__*/ bufferLayout.u32('tokenAccountsLength'),
  /*#__PURE__*/ uint64('precisionFactor'),
  /*#__PURE__*/ uint64('precisionMultiplierA'),
  /*#__PURE__*/ uint64('precisionMultiplierB'),
  /*#__PURE__*/ uint64('precisionMultiplierC'),
  /*#__PURE__*/ uint64('precisionMultiplierD'),
  /*#__PURE__*/ publicKey('tokenAccountA'),
  /*#__PURE__*/ publicKey('tokenAccountB'),
  /*#__PURE__*/ publicKey('tokenAccountC'),
  /*#__PURE__*/ publicKey('tokenAccountD'),
])
...
class MercurialAmm {
  ...
  get reserveTokenMints() {
    return this.params.tokenMints.map(
      (tokenMint) => new web3_js.PublicKey(tokenMint),
    )
  }
}
...
class CropperAmm {
  ...
  constructor(address, accountInfo, params) {
    ...
    this.params.tokenAFeeAccount = new web3_js.PublicKey(
      this.params.tokenAFeeAccount,
    )
    this.params.tokenBFeeAccount = new web3_js.PublicKey(
...
const SenchaSwapLayout = /*#__PURE__*/ bufferLayout.struct([
  /*#__PURE__*/ bufferLayout.blob(8, 'discriminator'),
  /*#__PURE__*/ publicKey('factory'),
  /*#__PURE__*/ bufferLayout.u8('bump'),
  /*#__PURE__*/ uint64('index'),
  /*#__PURE__*/ publicKey('admin'),
  /*#__PURE__*/ publicKey('token0Reserves'),
  /*#__PURE__*/ publicKey('token0Mint'),
  /*#__PURE__*/ publicKey('token0Fees'),
  /*#__PURE__*/ publicKey('token1Reserves'),
  /*#__PURE__*/ publicKey('token1Mint'),
  /*#__PURE__*/ publicKey('token1Fees'),
  /*#__PURE__*/ bufferLayout.u8('isPaused'),
  /*#__PURE__*/ publicKey('poolMint'),
  /*#__PURE__*/ uint64('tradeFeeKbps'),
  /*#__PURE__*/ uint64('withdrawFeeKbps'),
  /*#__PURE__*/ uint64('adminTradeFeeKbps'),
  /*#__PURE__*/ uint64('adminWithdrawFeeKbps'),
])
...
class WhirlpoolAmm {
  constructor(address, whirlpoolAccountInfo) {
    ...
    this.oracle = pubkey.findProgramAddressSync(
  ...
  getQuote({ sourceMint, destinationMint, amount, swapMode }) {
    const swapQuote = whirlpoolSdk.getSwapQuote({
      ...
      tokenMint:
        swapMode === exports.SwapMode.ExactIn ? sourceMint : destinationMint,
  ...
  createSwapInstructions(swapParams) {
    ...
    const ix =
      swapParams.swapMode === exports.SwapMode.ExactIn
  ...
  async eagerLoadCache(tickCurrent, tickSpacing) {
    ...
    try {
      ...
      const fetchedBitmaps =
        await this.program.account.tickBitmapState.fetchMultiple(bitmapsToFetch)
      const tickAddresses = []
...
const provider = /*#__PURE__*/ new anchor__namespace.AnchorProvider(
  null,
  null,
  {
    skipPreflight: false,
...
const CYCLOS_CORE = /*#__PURE__*/ new anchor__namespace.Program(
  cykuraSdk.IDL,
  CYKURA_PROGRAM_ID,
  provider,
)
class CykuraAmm {
  constructor(address, accountInfoOrPoolState) {
    ...
    this.vaults = {
      vault0: pubkey.findProgramAddressSync(
        [
      ...
      vault1: pubkey.findProgramAddressSync(
        [
          this.address.toBuffer(),
          splToken.TOKEN_PROGRAM_ID.toBuffer(),
          token1.toBuffer(),
  ...
  createSwapInstructions(swapParams) {
    ...
    const lastObservationState = pubkey.findProgramAddressSync(
      [
    ...
    const nextObservationState = pubkey.findProgramAddressSync(
      [
        cykuraSdk.OBSERVATION_SEED,
        this.poolState.token0.toBuffer(),
        this.poolState.token1.toBuffer(),
...
class MarinadeAmm {
  ...
  findProgramDerivedAddress(seed, extraSeeds = []) {
    ...
    const [result] = pubkey.findProgramAddressSync(
      seeds,
...
function ammFactory(address, accountInfo, params) {
  return wrapJupiterCore.ammFactory(address, accountInfo, params)
  ...
  if (
    ...
    const label =
      (_PROGRAM_ID_TO_LABEL$ = PROGRAM_ID_TO_LABEL.get(
    ...
    for (let [mint, amms] of startSegment.entries()) {
      let filteredAmms =
        swapMode === exports.SwapMode.ExactIn
          ? amms
          : amms.filter((amm) => amm.exactOutputSupported)
      ...
      if (
        onlyDirectRoutes ||
        swapMode === exports.SwapMode.ExactOut ||
      ...
      if (intersectionAmms) {
        let filteredIntersectionAmms =
          swapMode === exports.SwapMode.ExactIn
            ? intersectionAmms
            : intersectionAmms.filter((amm) => amm.exactOutputSupported)
  ...
  for (const [tokenMint, firstLevelOutputs] of tokenRouteSegments) {
    ...
    for (const [firstLevelOutputMint, firstLevelAmms] of firstLevelOutputs) {
      ...
      const secondLevelOutputs =
        (_tokenRouteSegments$g =
          tokenRouteSegments.get(firstLevelOutputMint)) !== null &&
        _tokenRouteSegments$g !== void 0
          ? _tokenRouteSegments$g
          : new Map()
      ...
      for (const [
        ...
        const outputMintSize =
          (_tokenRouteSegments$g2 =
            (_tokenRouteSegments$g3 = tokenRouteSegments.get(
              secondLevelOutputMint,
            )) === null || _tokenRouteSegments$g3 === void 0
              ? void 0
              : _tokenRouteSegments$g3.size) !== null &&
          _tokenRouteSegments$g2 !== void 0
            ? _tokenRouteSegments$g2
            : 0
...
function isSplitSetupRequired(marketInfos, { hasSerumOpenOrderInstruction }) {
  let firstAmm
  let secondAmm
...
function getRouteInfoUniqueId(routeInfo) {
  return routeInfo.marketInfos
    .map((marketInfo) => `${marketInfo.amm.id}-${marketInfo.inputMint}`)
    .join('-')
}
...
async function routeToInstructions({
  ...
  const effectiveQuoteMintToReferrer =
    platformFee && isSerumAndRaydium(routeInfo.marketInfos)
      ? undefined
      : quoteMintToReferrer
  const userIntermediateTokenAccountAddresses =
    userIntermediaryTokenAccountAddress
      ? [userIntermediaryTokenAccountAddress]
      : []
  ...
  for (const [index, marketInfo] of routeInfo.marketInfos.entries()) {
    ...
    const legOtherAmountThreshold = new BN.BN(
      (isLastLeg ? otherAmountThreshold : math.ZERO).toString(),
    )
    const legPlatformFee =
      isLastLeg && platformFeeSupported ? platformFee : undefined
    const [userSourceTokenAccount, userDestinationTokenAccount] =
      userTokenAccountAddresses.slice(index)
    instructions.push(
...
function diffTokenBalance(accountKeyIndex, meta) {
  var _meta$postTokenBalanc,
    _meta$postTokenBalanc2,
    _meta$preTokenBalance,
    _meta$preTokenBalance2

  const postBalance =
    (_meta$postTokenBalanc = meta.postTokenBalances) === null ||
    _meta$postTokenBalanc === void 0
      ? void 0
      : (_meta$postTokenBalanc2 = _meta$postTokenBalanc.find(
          (postTokenBalance) =>
            postTokenBalance.accountIndex === accountKeyIndex,
        )) === null || _meta$postTokenBalanc2 === void 0
      ? void 0
      : _meta$postTokenBalanc2.uiTokenAmount.amount
  const preBalance =
    (_meta$preTokenBalance = meta.preTokenBalances) === null ||
    _meta$preTokenBalance === void 0
      ? void 0
      : (_meta$preTokenBalance2 = _meta$preTokenBalance.find(
          (preTokenBalance) => preTokenBalance.accountIndex === accountKeyIndex,
        )) === null || _meta$preTokenBalance2 === void 0
      ? void 0
      : _meta$preTokenBalance2.uiTokenAmount.amount // When token account is created it isn't present in preBalance
...
function extractTokenBalanceChangeFromTransaction(
  meta,
  transaction,
  tokenAccountAddress,
) {
...
function extractSOLChangeFromTransaction(meta, transaction, user) {
  let accountKeyIndex = transaction.message.accountKeys.findIndex((p) =>
    p.equals(user),
  )

  if (accountKeyIndex !== -1) {
    return Math.abs(
      meta.postBalances[accountKeyIndex] - meta.preBalances[accountKeyIndex],
    )
...
function getTokenBalanceChangesFromTransactionResponse({
  ...
  if (!(sourceTokenBalanceChange && destinationTokenBalanceChange)) {
    throw new optimist.TransactionError(
...
async function transactionSenderAndConfirmationWaiter(
  connection,
  signedTransaction,
  timeout = 120000, // 2 minutes, (sendInterval * sendRetries) = 80_000 + extra wait 40_000
  pollInterval = 500,
  sendInterval = 2000,
  sendRetries = 40,
) {
...
const PLATFORM_FEE_DENOMINATOR =
  /*#__PURE__*/ JSBI__default['default'].BigInt(10000)
...
async function validateTransactionResponse({ txid, transactionResponse }) {
  ...
  if (
    ...
    let { message, code } = await optimist.parseErrorForTransaction(
      transactionResponse,
    )
...
async function getTopTokens() {
  const topTokens = await (
    await fetch__default['default']('https://cache.jup.ag/top-tokens')
  ).json()
...
class Jupiter {
  ...
  constructor(
    ...
    this.getDepositAndFeesForUser = ({ marketInfos }) => {
    ...
    this.exchange = async ({
      ...
      const _wrapUnwrapSOL =
        wrapUnwrapSOL !== null && wrapUnwrapSOL !== void 0
          ? wrapUnwrapSOL
          : this.wrapUnwrapSOL
        ...
        await Promise.all([
          inputMint.equals(WRAPPED_SOL_MINT) && _wrapUnwrapSOL
            ? createAndCloseWSOLAccount({
                ...
                owner,
                amount:
                  routeInfo.swapMode === exports.SwapMode.ExactIn
                    ? routeInfo.inAmount
            ...
            : splToken.Token.getAssociatedTokenAddress(
                ...
                owner.publicKey,
                true,
              ).then((address) => ({ ...getEmptyInstruction(), address })),
      ...
      feeAccount =
        feeAccount ||
        this.platformFeeAndAccounts.feeAccounts.get(outputMint.toBase58())
      const platformFee = feeAccount
        ? {
            feeBps:
              this.platformFeeAndAccounts.feeBps ||
              Math.floor(
                routeInfo.marketInfos[lastMarketInfoIndex].platformFee.pct *
                  100,
              ),
            feeAccount,
          }
  ...
  static async load({
    ...
    const [
      ...
      quoteMintToReferrer !== null && quoteMintToReferrer !== void 0
        ? quoteMintToReferrer
        : getPlatformFeeAccounts(
            connection,
            new web3_js.PublicKey(JUPITER_WALLET),
          ),
  ...
  async computeRoutes({
    ...
    const platformFeeBps =
      feeBps ||
      (this.platformFeeAndAccounts.feeAccounts.get(outputMintString)
        ? this.platformFeeAndAccounts.feeBps
        : 0)
    ...
    const inputMintAndOutputMint = [inputMintString, outputMintString]
  ...
  async executeInternal({
    ...
    try {
      ...
      if (setupTransaction) {
        onTransaction === null || onTransaction === void 0
          ? void 0
      ...
      try {
        ...
        if (cleanupTransaction) {
          onTransaction === null || onTransaction === void 0
            ? void 0
            : onTransaction(
                getSignature(cleanupTransaction),
                totalTxs,
                'CLEANUP',
...
Jupiter.createInitializeTokenLedgerInstruction =
  createInitializeTokenLedgerInstruction
...
exports.MIN_SEGMENT_SIZE_FOR_INTERMEDIATE_MINTS =
